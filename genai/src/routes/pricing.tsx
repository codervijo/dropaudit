...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "Pricing — DROPShield DROP compliance plans" },
      {
        name: "description",
        content:
          "Transparent pricing for California data brokers. Starter, Compliance, and Enterprise tiers for DROP / Delete Act readiness and operations.",
      },
      { property: "og:title", content: "DROPShield pricing" },
      { property: "og:description", content: "Plans for DROP readiness, suppression, vendor routing, and audit exports." },
    ],
  }),
