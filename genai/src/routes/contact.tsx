...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact DROPShield — DROP / Delete Act compliance" },
      {
        name: "description",
        content:
          "Talk to the DROPShield team about DROP readiness, pricing, and onboarding for your California data broker.",
      },
      { property: "og:title", content: "Contact DROPShield" },
      { property: "og:description", content: "Get in touch with the DROPShield compliance team." },
    ],
  }),
