...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "DROPShield — DROP / Delete Act compliance for California data brokers" },
      {
        name: "description",
        content:
          "Be DROP-ready before August 1, 2026. DROPShield is the compliance operations layer for California data brokers handling DROP deletion requests, suppression lists, and audit evidence.",
      },
      { property: "og:title", content: "DROPShield — Be DROP-ready before August 1" },
      {
        property: "og:description",
        content:
          "Compliance operations for California data brokers: deletion requests, suppression lists, vendor routing, and audit evidence.",
      },
    ],
  }),
  component: HomePage,
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <Button asChild size="lg" variant="outline" className="border-white/25 bg-white/5 text-white hover:bg-white/10 hover:text-white">
                <Link to="/product">View Compliance Workflow</Link>
              </Button>
            </div>
