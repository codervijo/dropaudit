      ...
      <div className="container mx-auto grid gap-10 px-4 py-14 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/75">
            <li><a href="/product" className="hover:text-white">Workflow</a></li>
            <li><a href="/pricing" className="hover:text-white">Pricing</a></li>
            <li><a href="/checklist" className="hover:text-white">Readiness Checklist</a></li>
            <li><a href="/calculator" className="hover:text-white">Penalty Calculator</a></li>
          </ul>
        </div>
        <div>
          <div className="mb-3 text-xs font-semibold uppercase tracking-wider text-white/60">
